            ...
            <div className="login-card">
                ...
                <form className="login-form" onSubmit={handleSubmit}>
                    ...
                    <div className="form-group">
                        ...
                        <div className="input-wrapper password-wrapper">
                            <svg className="input-icon lock-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="login-footer">
                    <p className="footer-text">
                        <svg className="footer-lock" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" style={{ width: '14px', height: '14px' }}>
